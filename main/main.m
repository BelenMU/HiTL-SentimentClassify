...
%% Parameters to set
filename = "results.mat";         % Directory in which to save results 
num_iterations = 2e3;             % Number of interactions with humans 
num_initializations = 10;         % Number of experiments
num_S = 4;                        % Number of words in query, $|\mathcal{S}|$
...
to_save = {'end_mu', 'end_sigma', 'mu_save', 'C_root_det', ...
    'MSE_MT_init', 'accu_init', 'max_score_init'};
